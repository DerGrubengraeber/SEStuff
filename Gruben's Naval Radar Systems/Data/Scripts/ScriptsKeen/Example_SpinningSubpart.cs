...
namespace Digi.Examples
{
    ...
    [MyEntityComponentDescriptor(typeof(MyObjectBuilder_BatteryBlock), false, "LG_dergrubengraeber_Huntress", "LG_dergrubengraeber_Ithaca", "SG_dergrubengraeber_Huntress", "SG_dergrubengraeber_Ithaca")]
    public class Example_SpinningSubpart : MyGameLogicComponent
    {
        private const string SUBPART_NAME = "RadarSpin"; // dummy name without the "subpart_" prefix
